 ...
 */
module.exports = async(client, msg, percentage, emiiter) => {
    ...
    if (require("./play").resource) require("./play").resource.volume.setVolume(percentage);
    emiiter.emit("volumeSong", msg, percentage);
}